...
const Contabilidad: React.FC = () => {
  ...
  const clientes = [
    {
      dominio: "fushi.cistcorfact.test",
      nombre: "TOJI FUSHI",
      ruc: "12112211212",
      correo: "fushi@gmail.com",
    },
    {
      dominio: "empresa2.cistcorfact.test",
      nombre: "EMPRESA DOS",
      ruc: "20987654321",
      correo: "contacto@empresa2.com",
    },
    {
      dominio: "empresa3.cistcorfact.test",
      nombre: "EMPRESA TRES",
      ruc: "20555555555",
      correo: "info@empresa3.com",
    },
  ];
  ...
  if (loading) {
    return (
      <LoadingSpinner message="Cargando contabilidad..." fullScreen={true} />
    );
  }
      ...
      <div className="bg-white dark:bg-[#161b22] rounded-2xl sm:rounded-[2rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden">
          ...
          <table className="min-w-full border-separate border-spacing-0">
            <thead>
              <tr className="bg-gray-50/50 dark:bg-gray-900/50 text-gray-400 uppercase text-[10px] sm:text-[11px] font-black tracking-[0.1em]">
                <th className="px-4 sm:px-6 lg:px-8 py-4 sm:py-5 text-left border-b border-gray-100 dark:border-gray-800">
                  Cliente / Dominio
                </th>
                <th className="px-3 sm:px-5 lg:px-6 py-4 sm:py-5 text-left border-b border-gray-100 dark:border-gray-800">
                  Identificación
                </th>
                <th className="px-3 sm:px-5 lg:px-6 py-4 sm:py-5 text-left border-b border-gray-100 dark:border-gray-800">
                  Contacto
                </th>
                <th className="px-4 sm:px-6 lg:px-8 py-4 sm:py-5 text-right border-b border-gray-100 dark:border-gray-800">
                  Acciones
                </th>
              </tr>
            </thead>
        ...
        <div className="md:hidden divide-y divide-gray-100 dark:divide-gray-800">
          {clientes.map((cliente, idx) => (
            <div
              key={idx}
              className="p-4 space-y-3 hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors"
            >
