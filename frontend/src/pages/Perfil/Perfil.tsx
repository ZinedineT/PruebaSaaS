  ...
  return (
    <div className="min-h-screen p-4 md:p-8 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-5xl mx-auto">
        ...
        {message && (
          <div className={`fixed top-5 right-5 z-50 flex items-center p-4 rounded-xl shadow-2xl border animate-in slide-in-from-right-10 ${
            message.type === 'success' 
              ? 'bg-white dark:bg-gray-800 border-green-500 text-green-600' 
              : 'bg-white dark:bg-gray-800 border-red-500 text-red-600'
          }`}>
            <div className={`p-2 rounded-full mr-3 ${message.type === 'success' ? 'bg-green-100' : 'bg-red-100'}`}>
              ...
              <form onSubmit={handleUpdateProfile} className="p-8 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-gray-600 dark:text-gray-400 ml-1">Nombre Completo</label>
